...
export const clientValidation = z.object({
  ...
  tradename: z.string({
    ...
    invalid_type_error: 'El nombre comercial no es valido!!',
  }).max(60, {
  ...
  regime: z.string({
    ...
    invalid_type_error: 'El regimen no es valido!!',
  }).min(5, {
  ...
  location: z.object({
    ...
    stret: z.string({required_error: 'La calle es obligatoria!!', invalid_type_error: 'La calle no es valida!!'}),
    cp: z.number({required_error: 'El codigo postal es obligatorio!!', invalid_type_error: 'El codigo postal es un numero!!'}),
    community: z.string({required_error: 'La colonia es obligatoria!!', invalid_type_error: 'La colonia no es valida!!'}),
    municipy: z.string({required_error: 'El municipio es obligatorio!!', invalid_type_error: 'El municipio no es valido!!'}),
    state : z.string({required_error: 'El estado es obligatorio!!', invalid_type_error: 'El estado no es valido!!'}),
    country: z.string({required_error: 'El pais es obligatorio!!', invalid_type_error: 'El pais no es valido!!'}),
