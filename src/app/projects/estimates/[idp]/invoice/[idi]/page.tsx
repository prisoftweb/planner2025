...
export default async function Page({ params, searchParams }: 
  ...
  const [project, invoice, totalInvoiceProject, collections, resresource, rescomponents] = await Promise.all([
    ...
    getAllComponentsByROUTESAndRESOURCESAndROLFULL(token, (user.rol?._id?? ''), 'projects', 'estimates/id/invoice/id'),
  ]);
