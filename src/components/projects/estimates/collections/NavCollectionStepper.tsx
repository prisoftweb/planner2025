...
export default function NavCollectionStepper({index, setIndex}: {index:number, setIndex:Function}){
      ...
      <div className="max-w-xl">
        ...
        >
          ...
          >
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Voucher </strong>
              <small className="mt-1">  </small>
            </p>
          </li>
          ...
          >
            <div className={`flex items-center justify-center border-t sm:border-t-0 sm:border-l border-gray-300
              ...
              <p className="leading-none">
                <strong className="block font-medium"> Dispersion </strong>
                <small className="mt-1"> </small>
              </p>
            </div>
          </li>
