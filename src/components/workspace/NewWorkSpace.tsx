  ...
  return (
    <div>
      <div className='w-full h-full hidden lg:flex justify-center'>
        <div className=' hidden lg:flex justify-center items-center min-h-full flex-1 bg-cover bg-center bg-no-repeat'
      ...
      <div className='w-full h-full flex lg:hidden justify-center'>
        <div className={`${responsive? 'hidden': ''} flex flex-col justify-center items-center min-h-screen flex-1 bg-cover bg-center bg-no-repeat`}
          // style={{ backgroundImage: "url('/img/workspaces/2174.jpg')" }}
          style={{backgroundImage:
                    "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/img/workspaces/2174.jpg')",
                  backgroundSize: "cover",
        ...
        >
          <p className='text-lg text-white px-14'>Controla y gestiona tus proyectos con las variables financieras adecuadas, cajas chicas, cobranza, facturacion</p>
          <div className='w-full flex justify-center mt-5'>
            {/*<Button onClick={() => setResponsive(true)}>Crear cuenta</Button>*/}
             <button
              className="text-white font-normal text-sm bg-slate-600 rounded-xl w-36 h-9 py-2 hover:bg-slate-500 print:hidden"
        ...
        <form className={`${responsive? '': 'hidden'} z-10 w-full max-w-lg h-full min-h-screen bg-white space-y-5 py-3 md:py-5 px-3 md:px-12 right-0`}
          onSubmit={formik.handleSubmit}
        >
