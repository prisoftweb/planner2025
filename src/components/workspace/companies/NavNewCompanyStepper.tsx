...
export default function NavNewCompanyStepper({index, handleIndexStepper}: {index:number, handleIndexStepper:(value: number) => void}){

  const changeTab = (indextab: number) => {
    if(index !== 0){
      handleIndexStepper(indextab);
    }
  }
        ...
        >
          ...
          >
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Datos Basicos </strong>
          ...
          >
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Logotipos </strong>
              <small className="mt-1">  </small>
            </p>
          </li>
          ...
          >
            <div className={`flex items-center justify-center border-t sm:border-t-0 sm:border-l border-gray-300
              ...
              <p className="leading-none">
                <strong className="block font-medium"> Facturacion </strong>
                <small className="mt-1"> </small>
              </p>
            </div>
          </li>
