...
export default function NavExpenseStepper({index}: {index:number}){
  
  const {indexStepper, updateIndexStepper, category} = useNewExpense();
  ...
  if(category=="661eae4ef642112488c85fb4"){
    return(
      <>
        <div className="max-w-3xl">
          ...
          >
            ...
            >
              ...
              <p className="leading-none">
                <strong className="block font-medium"> CFDI </strong>
                <small className="mt-1">  </small>
              </p>
            </li>
    ...
    if(category=="661eae12f642112488c85fb1" || category == "665f90b082c6db3d203cf093"){
      return(
        <>
          <div className="max-w-3xl">
            <ol
