...
export default function DownloadClientsReportPDF({clients, satCompany}:
  {clients:ClientBack[], satCompany:Company}) {
            ...
            <View style={{display:'flex', flexDirection:'column'}}>
              <View style={{display:'flex', flexDirection:'row', alignItems:'center', gap:'5px'}}>
                ...
                <View style={{display:'flex', flexDirection:'row', gap:'9px'}}>
                  <View>
                    <Text style={{fontSize:'15px', color:'gray', width: '250px'}}>CLIENTES</Text>
