...
export default function NavResponsive({open, setOpen, option, changeOption, tradeline, permissions}: 
  {open:boolean, setOpen:Function, option:number, changeOption:Function, tradeline: boolean, permissions:IPermissionsAndComponents}){
  ...
  if(!open){
    nav = (
      <div className="bg-white top-52 space-y-4 left-4 p-2 flex flex-col items-center rounded-md h-full shadow-md">
        ...
        {tradeline && permissions.components.includes('resume') && (
        ...
        {permissions.components.includes('basicinfo') && (
        ...
        {permissions.components.includes('creditline') && (
        ...
        {permissions.components.includes('bankdetails') && (
        ...
        {permissions.components.includes('deleteprovider') && (
