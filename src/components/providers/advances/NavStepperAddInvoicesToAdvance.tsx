...
export default function NavStepperAddInvoicesToAdvance({index, changeTab}: {index:number, changeTab: Function}){
        ...
        >
          ...
          >
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Facturas del anticipo </strong>
            </p>
          </li>
          ...
          >
            <div className={`flex items-center justify-center border-t sm:border-t-0 sm:border-l border-gray-300
                gap-2 p-4 ${index === 1? 'bg-blue-500 text-white': (index > 1? 'bg-green-500 text-white': 'text-gray-500')}`}>
              <span className="flex items-center justify-center w-8 h-8 border border-blue-600 rounded-full shrink-0 dark:border-blue-500">
                2
              </span>

              <p className="leading-none">
                <strong className="block font-medium"> Confirmar </strong>
              </p>
            </div>
          </li>
        </ol>
