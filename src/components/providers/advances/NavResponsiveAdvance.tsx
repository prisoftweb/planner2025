...
export default function NavResponsiveAdvance({open, setOpen, option, changeOption, permissions}: 
  {open:boolean, setOpen:Function, option:number, changeOption:Function, permissions:IPermissionsAndComponents}){
  ...
  if(!open){
    nav = (
      <div className="bg-white top-52 space-y-4 left-4 p-2 flex flex-col items-center rounded-md h-full shadow-md">
        ...
        {permissions.components.includes('uuidrelations') && (
